...
function createExampleDepartments() {
    return __awaiter(this, void 0, void 0, function () {
        var departments, i, department, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Department.bulkCreate(departments)];
                case 1:
                    // Tạo các bản ghi trong cơ sở dữ liệu
                    _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Lỗi khi tạo dữ liệu ví dụ:', error_1);
                    return [3 /*break*/, 3];
