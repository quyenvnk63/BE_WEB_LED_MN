...
var comparePasswords = require('../utils/passwordUtils').comparePasswords;
var loginValidator = require('../utils/validation').loginValidator;
exports.login = [
    loginValidator,
    function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, email, password, errors, user, isPasswordValid, token, userInfo, error_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, userService.generateToken(user.id)];
                case 4:
                    token = _b.sent();
                    userInfo = {
                        id: user.id,
